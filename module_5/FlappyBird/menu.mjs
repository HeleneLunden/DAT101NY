...
export class TMenu {
  ...
  #onClick = () => {
    if (this.#activeSprite === this.#spButtonPlay) {
      ...
      // Spill nedtellingslyd her!
      GameProps.sounds.countDown.pause();         // Stopp lyden hvis den spiller
      GameProps.sounds.countDown.currentTime = 0; // Hopp til starten
      GameProps.sounds.countDown.play();          // Spill lyden på nytt
  
      // Start visuell nedtelling etter 1 sekund
